    ...
    <div className="space-y-8" id="listings-grid-section">
          ...
          <div className="flex flex-wrap gap-2">
            {(['all', 'dat-tho-cu', 'dat-biet-thu', 'dat-vuon', 'dat-nen'] as const).map((type) => (
              <button
                ...
                className={`px-4.5 py-2 rounded-full text-xs font-bold font-mono tracking-wider uppercase transition-all border ${
                  selectedType === type
          ...
          {searchFilter.text && (
            <div className="text-xs bg-orange-50/40 text-slate-700 px-3.5 py-2 rounded-full border border-orange-100/65 flex items-center gap-2">
              ...
              <button 
                ...
                className="font-extrabold underline text-orange-600 hover:text-orange-700 uppercase font-mono tracking-wider ml-1 cursor-pointer"
              >
                Xóa lọc
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-5 border-t border-orange-50">
          ...
          <div className="space-y-2 text-left">
            <div className="flex justify-between items-center text-xs font-bold text-slate-500">
              <span className="uppercase tracking-wider">Mức Giá Tối Đa:</span>
          ...
          {/* Sort selection */}
          <div className="space-y-2 text-left">
            <span className="text-xs font-bold text-slate-500 block uppercase tracking-wider">Sắp xếp theo:</span>
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value as any)}
              className="w-full bg-white border border-orange-100 rounded-xl py-2 px-3.5 text-xs font-bold text-slate-800 transition-all outline-none shadow-sm focus:border-orange-400 font-mono uppercase"
            >
      ...
      {sortedListings.length === 0 ? (
        <div className="bg-white/80 backdrop-blur-md rounded-3xl p-12 text-center border border-orange-100 shadow-xl shadow-orange-950/5 max-w-sm mx-auto">
          ...
          <h3 className="text-base font-bold text-slate-850 mb-1 uppercase font-display">Không Tìm Thấy Lô Đất Phù Hợp</h3>
          ...
          <button
            ...
            className="text-xs font-semibold uppercase tracking-wider font-mono text-orange-600 hover:text-orange-700 underline cursor-pointer"
          >
            Khôi phục bộ lọc
          </button>
        </div>
            ...
            >
              ...
              <div className="relative h-[230px] overflow-hidden bg-slate-100 border-b border-orange-50/40">
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-1.5 z-10">
                  ...
                  {item.isFeatured && (
                    <span className="bg-slate-950 text-amber-400 font-sans text-[9px] uppercase font-black px-2.5 py-1 rounded-full flex items-center gap-1 shadow-sm">
                      ★ TIN CHỌN VIP
                    </span>
                  )}
                </div>
              ...
              <div className="p-6 text-left flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-extrabold text-slate-900 text-base leading-snug font-display group-hover:text-orange-600 transition-colors uppercase line-clamp-2 h-[44px] mb-3">
                    {item.title}
                  </h3>
                ...
                <div className="pt-4 border-t border-orange-50 flex items-center justify-between gap-2 mt-auto">
                  <div className="text-left">
                    <span className="text-[10px] text-slate-450 font-bold uppercase tracking-wider block">Người đăng:</span>
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-orange-100 max-h-[88vh] flex flex-col animate-scale-up">
            ...
            <div className="relative h-[240px] shrink-0">
              ...
              <div className="absolute bottom-4 left-6 right-6 text-white text-left z-10">
                ...
                <h3 className="text-xl sm:text-2xl font-black tracking-tight text-white leading-snug drop-shadow-md font-display uppercase border-b border-orange-500/40 pb-1">
            ...
            <div className="p-6 md:p-8 overflow-y-auto space-y-6 text-left flex-1 bg-gradient-to-b from-white to-[#FFFAF5]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-orange-50/40 border border-orange-100/60 p-4 rounded-2xl text-center">
                  <span className="text-[10px] text-slate-450 font-extrabold uppercase tracking-wider font-mono block">Diện Tích</span>
                  <span className="text-sm font-black font-mono text-slate-800 mt-1 block">{selectedListingDetail.size} m²</span>
                </div>

                <div className="bg-orange-50/40 border border-orange-100/60 p-4 rounded-2xl text-center">
                  <span className="text-[10px] text-slate-450 font-extrabold uppercase tracking-wider font-mono block">Mặt Tiền m</span>
                ...
                <div className="bg-orange-50/40 border border-orange-100/60 p-4 rounded-2xl text-center">
                  <span className="text-[10px] text-slate-450 font-extrabold uppercase tracking-wider font-mono block">Chiều Sâu m</span>
                  <span className="text-sm font-black font-mono text-slate-800 mt-1 block">
                ...
                <div className="bg-orange-50/40 border border-orange-100/60 p-4 rounded-2xl text-center">
                  <span className="text-[10px] text-slate-450 font-extrabold uppercase tracking-wider font-mono block">Hướng Đất</span>
              ...
              <div className="space-y-2">
                <h4 className="text-xs font-bold tracking-wider text-slate-500 uppercase flex items-center gap-1.5 font-display">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-orange-50">
                <div className="space-y-1">
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Vị Trí Quy Hoạch:</span>
                  <span className="text-xs font-bold text-slate-700 block">{selectedListingDetail.location}</span>
                </div>

                <div className="space-y-1">
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Tình Trạng Pháp Lý:</span>
              ...
              <div className="bg-orange-50/20 p-4 rounded-2xl flex items-center justify-between border border-orange-100/50 gap-4">
                <div className="text-left">
                  <span className="text-[10px] text-slate-500 font-bold uppercase block mb-1 font-mono tracking-wider">Tọa độ định vị chuẩn vệ tinh:</span>
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-605 hover:to-orange-605 text-white font-bold text-xs uppercase tracking-wider font-mono px-4 py-2.5 rounded-full transition-all shrink-0 cursor-pointer flex items-center gap-1 shadow-md shadow-orange-500/10"
                >
              ...
              <div className="pt-6 border-t border-orange-100 flex flex-col sm:flex-row items-start sm:items-center justify-between bg-white border border-orange-100/50 p-4 rounded-2xl gap-4 shadow-sm shadow-orange-950/2">
                <div className="text-left">
                  <span className="text-[10px] text-slate-400 font-bold uppercase block">Người đại diện / Ký gửi:</span>
                ...
                <div className="flex flex-wrap gap-2.5 w-full sm:w-auto">
                  <a
                    ...
                    className="flex-1 bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold text-xs uppercase tracking-wider px-4.5 py-3 rounded-full transition-all text-center shadow-lg shadow-orange-500/15 cursor-pointer flex items-center justify-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 bg-slate-55 hover:bg-orange-50/40 border border-orange-100 text-slate-700 font-bold text-xs uppercase tracking-wider px-4.5 py-3 rounded-full transition-all cursor-pointer text-center"
                  >
                    Yêu cầu nhanh
                  </button>
                </div>
